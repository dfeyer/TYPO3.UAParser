...
/**
 * ua-parser-php is the PHP library for the ua-parser project
 *
 * @author Dave Olsen
...
class Parser {
	...
	public static $silent = false; // no output when running UAParser::get()
	public static $nobackup = false; // don't create a back-up when running UAParser::get()
	...
	public static function parse($ua = NULL) {
		...
		if (empty(self::$regexes)) {
			self::$regexes = Yaml::parse("resource://TYPO3.UAParser/Private/Regexes/regexes.yaml");
		}
